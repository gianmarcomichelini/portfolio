    ...
    theme: {
        extend: {
            ...
            colors: {
                ...
                primary: '#1F2937',           // dark primary text (gray-800)
                secondary: '#6B7280',         // secondary text (gray-500)
                textLight: '#4B5563',         // tertiary/medium gray text (gray-600)
                textMuted: '#9CA3AF',         // muted/soft gray text (gray-400)
                gradientTextStart: '#4F46E5', // indigo-600 (for text gradients)
            ...
            backgroundImage: {
                ...
                text_gradient: 'linear-gradient(90deg, #4f46e5, #8b5cf6)',                       // horizontal text gradient
            },
        },
    },
    plugins: [daisyui],
